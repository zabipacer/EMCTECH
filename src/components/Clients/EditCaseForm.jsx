      ...
      try {
        if (db) {
          ...
          if (caseDoc.exists()) {
            ...
            // Set client search if clientId exists
          ...
          // Demo mode - set some sample data
          setFormData({
            caseNumber: 'CASE-001',
            caseTitle: 'Sample Case',
            partyName: 'John Doe',
            adjournDate: '2023-12-15',
            hearingDate: '2023-12-01T10:00',
            underSection: '489 F',
          ...
          setClientSearch('Acme Corp');
          setCourtSearch('District Court – Lahore');
        }
      } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8 px-4">
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-8">
          ...
          <p className="text-slate-600">Update case details for {formData.caseNumber}</p>
          {!db && (
